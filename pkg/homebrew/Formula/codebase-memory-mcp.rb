class CodebaseMemoryMcp < Formula
  ...
  homepage "https://github.com/ycsx/codebase-memory-mcp"
  version "0.8.1"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/ycsx/codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-darwin-arm64.tar.gz"
      sha256 "fbd047509852021b5446a11141bcb0a3d1dcaebf6e5112460960f29f052c1c58"
    end
    on_intel do
      url "https://github.com/ycsx/codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/ycsx/codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-linux-arm64.tar.gz"
      sha256 "d2f842d1365da5c35d9c5796f57a821c9745267350994346735e1e6e04d46091"
    end
    on_intel do
      url "https://github.com/ycsx/codebase-memory-mcp/releases/download/v#{version}/codebase-memory-mcp-linux-amd64.tar.gz"
  ...
  def caveats
    <<~EOS
      ...
      To tap this formula directly:
        brew tap ycsx/codebase-memory-mcp https://github.com/ycsx/codebase-memory-mcp
