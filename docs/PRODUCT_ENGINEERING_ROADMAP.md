...
> 状态：W3-W6 MVP 已交付；真实 PR 影子评审、远程服务运营遥测和文档关系质量进入验收
...
当前 `TOOLS[]` 已经包含 19 个原子 MCP 工具，主要覆盖：
...
- 远程 Git 同步、配额/限流、查询缓存和优先级队列仍未产品化。
...
| `build_context` | 18 个原子工具、搜索、影响、ADR | 编排、排序、去重、预算 | 5/5 | M | P1 主功能 |
