...
export const messages = {
  en: {
    ...
    index: {
      ...
      restrictedInstructions: (path: string) => `This server can index ${path} and its subdirectories.`,
      remoteInstructions: "Public HTTPS repositories need no SSH setup. Private SSH repositories use this machine's deploy key and OpenSSH host trust.",
      ...
      remoteProjectNameHelp: "Leave blank to derive it from the repository name; duplicate names are distinguished automatically. The same project can keep separate local and Git graphs.",
  ...
  zh: {
    ...
    index: {
      ...
      restrictedInstructions: (path: string) => `此服务器仅允许索引 ${path} 及其子目录。`,
      remoteInstructions: "公开 HTTPS 仓库无需 SSH 配置；私有 SSH 仓库使用本机部署密钥和 OpenSSH 主机信任。",
      repositoryPath: "仓库路径",
      repositoryUrl: "仓库地址",
      ...
      remoteProjectNameHelp: "留空按仓库名生成，重名时自动区分；同一项目可分别保留本地和Git图谱。",
      filterFolders: "筛选目录",
