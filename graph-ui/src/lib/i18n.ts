...
export const messages = {
  en: {
    ...
    index: {
      ...
      repositoryUrlPlaceholder: "git@github.com:company/repository.git or https://github.com/company/repository",
      branch: "Branch",
  ...
  zh: {
    ...
    index: {
      ...
      repositoryPath: "仓库路径",
      repositoryUrl: "仓库地址",
      repositoryUrlPlaceholder: "git@github.com:company/repository.git 或 https://github.com/company/repository",
      branch: "分支",
      pollInterval: "轮询间隔",
      minutes: "分钟",
